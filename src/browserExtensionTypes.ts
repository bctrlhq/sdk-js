...
export type V1BrowserExtensionFormat =
  OpenApiSchemas["BrowserExtension"]["format"];
export type V1BrowserExtensionSource = "upload" | "url";

export type V1BrowserExtension = OpenApiSchemas["BrowserExtension"];

export type V1BrowserExtensionListQuery =
  OpenApiQuery<"browser-extensions.list">;
...
export type V1BrowserExtensionUpdateRequest =
  OpenApiSchemas["BrowserExtensionUpdateRequest"];
