...
export class V1BrowserExtensionsClient {
  ...
  ): Promise<V1ListEnvelope<V1BrowserExtension>> {
    return this.http.request<V1ListEnvelope<V1BrowserExtension>>(
      "/browser-extensions",
      {
        query,
      },
  ...
  upload(
    request: V1BrowserExtensionUploadRequest,
  ...
  import(
    request: V1BrowserExtensionImportRequest,
  ): Promise<V1BrowserExtension> {
